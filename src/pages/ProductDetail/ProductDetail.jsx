    ...
    <>
      ...
      <div className="flex gap-[30px] px-24">
        ...
        <div className="flex flex-col gap-[20px]">
          ...
          {product.stock > 0 ? (
            product.stock <= 25 ? (
              <span className="text-[16px] font-medium text-yellow-500">Available, almost out of stock</span>
            ) : (
              <span className="text-[16px] font-medium text-green-500">Available</span>
            )
          ) : (
            <span className="text-[16px] font-medium text-red-500">Out of stock</span>
          )}
